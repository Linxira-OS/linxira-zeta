				...
				>
					<label style={{ color: "var(--text-dim)", display: "grid", fontSize: 11, gap: 4 }}>
						...
						<select
							...
							style={selectStyle}
						>
							{(Object.entries(MODE_LABELS) as Array<[ThemeMode, string]>).map(([value, label]) => (
					...
					<label style={{ color: "var(--text-dim)", display: "grid", fontSize: 11, gap: 4 }}>
						...
						<select
							value={lightThemeId}
							onChange={event => setLightThemePreference(event.target.value)}
							style={selectStyle}
						>
					...
					<label style={{ color: "var(--text-dim)", display: "grid", fontSize: 11, gap: 4 }}>
						...
						<select
							value={darkThemeId}
							onChange={event => setDarkThemePreference(event.target.value)}
							style={selectStyle}
						>
