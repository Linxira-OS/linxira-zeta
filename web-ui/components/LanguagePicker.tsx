...
export function LanguagePicker() {
	...
	const langOptions: LangOption[] = supportedLocales.map(plugin => ({
		id: plugin.id,
		label: plugin.label,
		sub: plugin.id === "zh-CN" ? t("language.sub-zh") : plugin.label,
	...
	return (
		<div ref={rootRef} style={{ position: "relative", flexShrink: 0 }}>
			...
			<button
				...
				title={t("language.title-fmt", {
					current: locale === "zh-CN" ? t("language.name-zh") : t("language.name-en"),
				})}
			...
			>
				...
				>
					{locale === "zh-CN" ? t("language.short-zh") : t("language.short-en")}
				</span>
				{/* Chevron */}
				<svg
					width="8"
