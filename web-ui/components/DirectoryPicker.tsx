...
export function DirectoryPicker({
  ...
  const canNavigateUp =
    Boolean(parentDirectory) || isWindowsDriveRoot(currentPath);
    ...
    >
      ...
      >
        ...
        >
          ...
          {hasNativeDirectoryDialog() && (
            <button
              ...
              onClick={async () => {
                const picked = await selectNativeDirectory(
          ...
          {loading ? (
            ...
            <>
              {drives.length > 0 ? (
                ...
                <div
                  style={{ padding: 8, color: "var(--text-dim)", fontSize: 11 }}
                >
        ...
        >
          ...
          >
            {busy ? t("checking") : t("directoryPicker.selectThisFolder")}
          </button>
        </div>
      </div>
    </div>,
