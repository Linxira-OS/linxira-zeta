...
function versionSummary(
  ...
  const parts = [];
  if (pkg.version)
    parts.push(t("plugins.installedVersion", { version: pkg.version }));
  if (pkg.configuredVersion)
    parts.push(
      t("plugins.configuredVersion", { version: pkg.configuredVersion }),
    );
