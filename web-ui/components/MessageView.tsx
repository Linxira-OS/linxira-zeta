						...
						>
							...
							{canFork && (
								<button
									...
									disabled={forking}
									title={
										forking ? "Creating new session…" : "New session — creates an independent copy from here"
									}
									style={{
										display: "flex",
										alignItems: "center",
            ...
            message's timestamp, so it is an estimate. */}
				...
				{thinkingDurationFromFile !== undefined && !isStreaming && (
					<span
						...
						style={{ display: "flex", alignItems: "center", gap: 2, fontVariantNumeric: "tabular-nums" }}
					>
						<span aria-hidden>⏱</span>
	...
	return (
		<div style={{ marginBottom: 16 }}>
			...
			>
				...
				>
					<span
						style={{ color: "var(--text-muted)", fontFamily: "var(--font-mono)", fontSize: 11, fontWeight: 650 }}
					>
						{title}
					</span>
					{isHiddenDisplay && (
