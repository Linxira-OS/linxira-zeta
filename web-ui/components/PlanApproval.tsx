		...
		>
			...
			<div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
				<ActionButton
					...
					color="#22c55e"
				/>
				<ActionButton label="Summarize & execute" onClick={() => handleApprove("compact")} color="#3b82f6" />
				<ActionButton label="New session & execute" onClick={() => handleApprove("fresh")} color="#f59e0b" />
				<ActionButton label="Cancel" onClick={() => handleApprove("cancel")} color="#ef4444" />
			</div>
		</div>
	);
}
