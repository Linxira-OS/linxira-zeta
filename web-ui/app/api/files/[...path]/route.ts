...
import { inspectUploadTargets, parseUploadConflictStrategy, validateUploadFileNames } from "@/lib/file-upload";
...
async function getUploadDirectory(segments: string[]): Promise<{ directory: string } | { response: NextResponse }> {
