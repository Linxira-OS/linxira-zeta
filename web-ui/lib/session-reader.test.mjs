...
const { buildSessionContext, cacheSessionPath, invalidateSessionPathCache, readSessionHeader, resolveSessionIdByPath } =
	...
	const entries = [
		...
		assistantEntry("a1", "u1", "reading"),
		{
			...
			message: {
				role: "toolResult",
				toolCallId: "call1",
				content: [{ type: "text", text: "Read image file" }, toolImage, flatToolImage, toolUrlImage],
			},
		},
	];
