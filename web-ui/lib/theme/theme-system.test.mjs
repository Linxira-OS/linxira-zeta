...
const { DEFAULT_DARK_THEME_ID, DEFAULT_LIGHT_THEME_ID, getThemeById, themes, validateThemeRegistry } =
...
test("registry validates all checked-in resources and normalizes Vitesse ids", () => {
	...
	assert.throws(
		() => validateThemeRegistry([{ ...themes[0], colors: { ...themes[0].colors, chart: [] } }]),
		/8 chart/,
	);
});
