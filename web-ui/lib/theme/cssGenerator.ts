...
export class CSSVariableGenerator {
	...
	generateLegacyAliases(theme: Theme): Array<[string, string]> {
		...
		return [
			...
			["--bg-panel", colors.surface.muted],
			["--bg-elevated", colors.surface.elevated],
			["--bg-hover", colors.interactive.hover],
			["--bg-selected", colors.interactive.selection],
			["--bg-subtle", colors.surface.subtle],
			["--border", colors.interactive.border],
			["--text", colors.surface.foreground],
			["--text-muted", colors.surface.mutedForeground],
			["--text-dim", colors.syntax.lineNumber],
			["--accent", colors.primary.base],
			["--accent-hover", colors.primary.hover],
			["--accent-active", colors.primary.active],
			["--accent-muted", colors.primary.muted],
			["--accent-dim", colors.primary.muted],
			["--accent-foreground", colors.primary.foreground],
			["--user-bg", colors.chat.userBackground],
			["--assistant-bg", colors.chat.assistantBackground],
			["--tool-bg", colors.chat.toolBackground],
			["--color-bg", colors.surface.background],
			["--color-bg-panel", colors.surface.muted],
			["--color-bg-hover", colors.interactive.hover],
			["--color-bg-selected", colors.interactive.selection],
			["--color-border", colors.interactive.border],
			["--color-text", colors.surface.foreground],
			["--color-text-muted", colors.surface.mutedForeground],
			["--color-text-dim", colors.syntax.lineNumber],
			["--color-accent", colors.primary.base],
			["--color-accent-hover", colors.primary.hover],
			["--color-user-bg", colors.chat.userBackground],
			["--color-assistant-bg", colors.chat.assistantBackground],
			["--color-tool-bg", colors.chat.toolBackground],
			["--color-bg-subtle", colors.surface.subtle],
		];
	}
