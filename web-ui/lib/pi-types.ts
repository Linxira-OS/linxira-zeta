/**
 * Local stand-ins for CLI-side types. The `@earendil-works/pi-coding-agent`
 * package is not a web-ui dependency — web-ui only observes these shapes
 * through the gateway — so the few referenced types are declared here.
 */
