export interface PiCliSlashCommand {
	name: string;
	description?: string;
	argumentHint?: string;
}

export const PI_CLI_BUILTIN_SLASH_COMMANDS: ReadonlyArray<PiCliSlashCommand> = [
	...
	{
		name: "plan-ultra",
		description: "Start ultra plan mode (deeper scouting and incremental plan writes)",
		argumentHint: "<task>",
	},
