...
describe("crew/model override", () => {
	...
	it("resolveModel follows task -> params -> role -> config -> session -> agent priority", () => {
		expect(
			resolveModel("task-model", "param-model", "role-model", "config-model", "session-model", "agent-model"),
		).toBe("task-model");
		expect(resolveModel(undefined, "param-model", "role-model", "config-model", "session-model", "agent-model")).toBe(
			"param-model",
		);
		expect(resolveModel(undefined, undefined, "role-model", "config-model", "session-model", "agent-model")).toBe(
			"role-model",
		);
		expect(resolveModel(undefined, undefined, undefined, "config-model", "session-model", "agent-model")).toBe(
			"config-model",
		);
		expect(resolveModel(undefined, undefined, undefined, undefined, "session-model", "agent-model")).toBe(
			"session-model",
		);
