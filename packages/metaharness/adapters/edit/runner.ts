...
import { EditStore, hashlineCountOps, hashlineFormatHeader } from "@linxiraos/pi-natives";
...
import { formatSessionDumpText, RpcClient } from "@linxiraos/pi-coding-agent";
...
const CLI_PATH = Bun.fileURLToPath(import.meta.resolve("@linxiraos/pi-coding-agent/cli"));
