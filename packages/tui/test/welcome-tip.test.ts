...
import { renderWelcomeTip, WelcomeComponent } from "@linxiraos/pi-tui/prompt/welcome";
import { initTheme, setSymbolPreset, setTheme, theme } from "@linxiraos/pi-tui/theme";
