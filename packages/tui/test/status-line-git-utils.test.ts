...
import {
	...
	parseDefaultBranch,
	parseGitHubRepo,
} from "../src/status-line/git-utils";
...
describe("parseGitHubRepo", () => {
	...
	test("parses SSH scp-style URL", () => {
		expect(parseGitHubRepo("git@github.com:loftiskg/linxira-zeta.git")).toBe("loftiskg/linxira-zeta");
	});

	test("parses SSH scp-style URL without .git suffix", () => {
		expect(parseGitHubRepo("git@github.com:loftiskg/linxira-zeta")).toBe("loftiskg/linxira-zeta");
	});
