...
import { renderSegmentTrack, resolveSegmentPalette, type TrackSegment } from "@linxiraos/pi-tui/chrome/segment-track";
import { initTheme, type ThemeColor, theme } from "@linxiraos/pi-tui/theme";
