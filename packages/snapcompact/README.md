...
```sh
bun add @linxiraos/pi-snapcompact
```
...
```ts
import { renderMany, frames, resolveShape } from "@linxiraos/pi-snapcompact";
...
```ts
import { compact } from "@linxiraos/pi-snapcompact";
