...
Local SQLite memory engine for Zeta agents.
...
```ts
import { Mnemopi } from "@linxiraos/pi-mnemopi";
...
The Zeta coding-agent wrapper adds `mnemopi.scoping` on top of those constructor options:
