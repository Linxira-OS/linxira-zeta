/**
 * `zeta completions <bash|zsh|fish>` — print a shell completion script.
 *
...
import { APP_NAME, postmortem, VERSION } from "@linxiraos/pi-utils";
import { Args, type CliConfig, Command, type CommandCtor } from "@linxiraos/pi-utils/cli";
