...
import { isEnoent, parseFrontmatter } from "@linxiraos/pi-utils";
import { SKILL_DEFAULT_IGNORES, SKILL_LIMITS, SKILL_NAME_MAX, SKILL_NAME_RE } from "@linxiraos/pi-wire/skillshare";
...
/** Agent Skills spec validation plus the registry's stricter rules (see `@linxiraos/pi-wire/skillshare`). */
