import type { AgentOptions } from "@zeta/pi-agent-core";
import type { OAuthAccessResolution } from "@zeta/pi-ai";
import type { ApiKeyResolver } from "@zeta/pi-ai/auth-retry";
