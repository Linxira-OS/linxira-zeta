...
// Zeta: the event union stays re-exported from here. Upstream v18.3.0 imports it
// from ./agent-session-events directly, but ~83 Zeta call sites (controllers,
// channels, autolearn, tui) import it from this module; keeping the re-export
// preserves that contract across the upstream split.
