...
import { commandPreview } from "@linxiraos/pi-tui/overlays/extensions/inspector-model";
import { inferMcpTransport } from "@linxiraos/pi-tui/overlays/extensions/mcp-runtime";
import {
	type DisabledReason,
	type Extension,
	type ExtensionKind,
	...
	makeExtensionId,
	sourceFromMeta,
} from "@linxiraos/pi-tui/overlays/extensions/types";
 ...
 * `~/.zeta/plugins` and loads without the opt-in — so the dashboard must render
