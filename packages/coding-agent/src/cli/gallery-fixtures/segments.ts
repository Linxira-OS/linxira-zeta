...
import type { StatusLineSegmentId } from "@linxiraos/pi-tui/status-line/schema";
import { ALL_SEGMENT_IDS, renderSegment } from "@linxiraos/pi-tui/status-line/segments";
