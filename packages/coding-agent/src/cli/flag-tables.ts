 ...
 * `@linxiraos/pi-utils` (or anything that transitively does). That package's
 ...
 * runtime imports from `@linxiraos/pi-utils`, which is the whole reason it can
 ...
 * argument — `zeta --print --profile work` still selects a profile) apart from an
 ...
 * a flag's value instead of mistaking it for the subcommand — `zeta --model acp`
