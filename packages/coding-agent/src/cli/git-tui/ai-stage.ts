...
import type { ChoiceQuestion, ScoreQuestion } from "@linxiraos/pi-ai";
...
import type { ChangedFile } from "@linxiraos/pi-tui/apps/git/state";
import type { AiStageOutcome } from "@linxiraos/pi-tui/apps/git/git-tui";
