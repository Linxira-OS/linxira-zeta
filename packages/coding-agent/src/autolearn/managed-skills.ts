 ...
 * isolated directory (`~/.zeta/agent/managed-skills`) separate from
 * user-authored skills (`~/.zeta/agent/skills`). They are discovered and
...
import { getAgentDir, isEnoent } from "@linxiraos/pi-utils";
...
/** Resolve the isolated managed-skills directory (`~/.zeta/agent/managed-skills`). */
