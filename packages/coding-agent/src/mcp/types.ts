import type { MCPContent, MCPImageContent, MCPResourceContent, MCPTextContent } from "@linxiraos/pi-tui/tools/mcp";
/**
...
export const MCP_CONFIG_SCHEMA_URL =
	"https://raw.githubusercontent.com/Linxira-OS/linxira-zeta/main/packages/coding-agent/src/config/mcp-schema.json";
