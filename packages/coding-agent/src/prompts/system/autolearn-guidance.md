...
Managed skills: `SKILL.md` in isolated `~/.zeta/agent/managed-skills`; surfaced in future sessions like other skills.
...
Isolation: managed skills ONLY writable skills. NEVER edit user-authored skills in `~/.zeta/agent/skills` or `.zeta/skills`.
