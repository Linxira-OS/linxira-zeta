Publish current Zeta-native security scan's canonical result.
...
Tool: validates, fingerprints, assigns Zeta-owned IDs, writes canonical security store, creates SARIF.
