...
import { type LaunchParams } from "@linxiraos/pi-tui/tools/hub";
import {
	drainPendingInbox,
	executeInbox,
	executeList,
...
import { DEFAULT_HUB_LIST_LIMIT, type HubDetails, MAX_HUB_LIST_LIMIT } from "@linxiraos/pi-tui/tools/hub";
import { hubErrorResult } from "./types";

export type { LaunchParams, LaunchToolDetails } from "@linxiraos/pi-tui/tools/hub";
...
const hubSchema = type({
	...
	"persist?": type("boolean").describe("start: survive the last zeta client exiting; default false"),
