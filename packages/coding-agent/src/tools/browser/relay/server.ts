 ...
 *
 * Impersonates Chrome's CDP discovery endpoint so the zeta browser tool (and
...
/** Default appearance of the zeta tab group. */
const DEFAULT_GROUP = { title: "zeta", color: "cyan" } as const;
