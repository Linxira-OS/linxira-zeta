/**
 * `zeta compress` — rewrite text files into the dense prompt register.
 *
...
/** User-facing options for `zeta compress`. */
 ...
 * stdout for a single-file run (`zeta compress f.md > out.md`).
 */
