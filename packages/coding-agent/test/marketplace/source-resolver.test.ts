...
import type { MarketplacePluginEntry } from "@zeta/pi-coding-agent/extensibility/plugins/marketplace";
import { resolvePluginSource } from "@zeta/pi-coding-agent/extensibility/plugins/marketplace";
