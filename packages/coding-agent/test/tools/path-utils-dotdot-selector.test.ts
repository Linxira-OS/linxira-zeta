...
describe("isFilesystemSourcePath", () => {
	it("accepts POSIX, Windows drive, and UNC paths", () => {
		...
		expect(isFilesystemSourcePath("C:\\repo\\.zeta\\tools\\systemd.ts")).toBe(true);
		expect(isFilesystemSourcePath("C:/.zeta/tools/systemd.ts")).toBe(true);
		expect(isFilesystemSourcePath("\\\\server\\share\\.zeta\\tools\\systemd.ts")).toBe(true);
		expect(isFilesystemSourcePath("//server/share/.zeta/tools/systemd.ts")).toBe(true);
