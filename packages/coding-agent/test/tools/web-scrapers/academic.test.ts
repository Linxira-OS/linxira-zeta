...
import { handleArxiv } from "@zeta/pi-coding-agent/web/scrapers/arxiv";
import { handleIacr } from "@zeta/pi-coding-agent/web/scrapers/iacr";
import { handlePubMed } from "@zeta/pi-coding-agent/web/scrapers/pubmed";
import { handleSemanticScholar } from "@zeta/pi-coding-agent/web/scrapers/semantic-scholar";
import type { RenderResult } from "@zeta/pi-coding-agent/web/scrapers/types";
