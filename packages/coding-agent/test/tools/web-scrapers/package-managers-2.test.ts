...
import { handleChocolatey } from "@zeta/pi-coding-agent/web/scrapers/chocolatey";
import { handleDockerHub } from "@zeta/pi-coding-agent/web/scrapers/dockerhub";
import { handleHackage } from "@zeta/pi-coding-agent/web/scrapers/hackage";
import { handleMetaCPAN } from "@zeta/pi-coding-agent/web/scrapers/metacpan";
import { handleRepology } from "@zeta/pi-coding-agent/web/scrapers/repology";
import { handleTerraform } from "@zeta/pi-coding-agent/web/scrapers/terraform";
