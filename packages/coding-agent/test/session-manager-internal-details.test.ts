...
import { type SkillPromptDetails, stripInternalDetailsFields } from "@zeta/pi-coding-agent/session/messages";
import type { CustomMessageEntry } from "@zeta/pi-coding-agent/session/session-entries";
