...
import { type SkillPromptDetails, stripInternalDetailsFields } from "@linxiraos/zeta/session/messages";
import type { CustomMessageEntry } from "@linxiraos/zeta/session/session-entries";
