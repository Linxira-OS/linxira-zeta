...
import { loadCapability, setDisabledProviders } from "@linxiraos/zeta/capability";
import type { ContextFile } from "@linxiraos/zeta/capability/context-file";
import { clearCache } from "@linxiraos/zeta/capability/fs";
import type { Instruction } from "@linxiraos/zeta/capability/instruction";
import type { Prompt } from "@linxiraos/zeta/capability/prompt";
import { type Rule, resetActiveRulesForTests, setActiveRules } from "@linxiraos/zeta/capability/rule";
import { RuleProtocolHandler } from "@linxiraos/zeta/internal-urls/rule-protocol";
import { removeSyncWithRetries } from "@linxiraos/pi-utils";
import "@linxiraos/zeta/capability/context-file";
import "@linxiraos/zeta/capability/instruction";
import "@linxiraos/zeta/capability/prompt";
import "@linxiraos/zeta/capability/rule";
