...
import { Agent, type AgentMessage, type CompactionSummaryMessage } from "@linxiraos/pi-agent-core";
import * as compactionModule from "@linxiraos/pi-agent-core/compaction";
import { calculateContextTokens, resolveThresholdTokens } from "@linxiraos/pi-agent-core/compaction";
import { buildOpenAiNativeHistory } from "@linxiraos/pi-agent-core/compaction/openai";
import type { AssistantMessage, Model, OpenAIResponsesHistoryPayload } from "@linxiraos/pi-ai";
