...
import { applyDisabledExtensionsToState } from "@linxiraos/zeta/modes/components/extensions/state-manager";
import type { DashboardState, Extension } from "@linxiraos/zeta/modes/components/extensions/types";
