...
import { getPrompt, listPrompts, serverSupportsPrompts } from "@linxiraos/zeta/mcp/client";
import type { MCPGetPromptResult, MCPPrompt, MCPPromptsListResult } from "@linxiraos/zeta/mcp/types";
