...
import { GreenCommand } from "@zeta/pi-coding-agent/extensibility/custom-commands/bundled/ci-green";
...
import type * as TypeBox from "@zeta/pi-coding-agent/extensibility/typebox";
