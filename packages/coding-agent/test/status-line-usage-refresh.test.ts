...
import type { CodexResetFireworksEvent } from "@linxiraos/pi-tui/overlays/codex-reset-fireworks";
...
import { cfgTuiCodexResetFireworks } from "@linxiraos/zeta/modes/settings";
