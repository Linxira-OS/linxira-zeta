...
import { SETTINGS_SCHEMA, type SettingPath } from "@linxiraos/zeta/config/settings-schema";
import { getSettingsForTab, SETTING_TABS, type SettingTab, TAB_GROUPS } from "@linxiraos/pi-tui/overlays/settings-defs";
