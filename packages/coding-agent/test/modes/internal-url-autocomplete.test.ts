...
import { resetActiveRulesForTests, setActiveRules } from "@zeta/pi-coding-agent/capability/rule";
...
import {
	...
	isInternalUrlPrefix,
} from "@zeta/pi-coding-agent/modes/internal-url-autocomplete";
import { PromptActionAutocompleteProvider } from "@zeta/pi-coding-agent/modes/prompt-action-autocomplete";
