...
- [Monorepo README (GitHub)](https://github.com/Linxira-OS/linxira-zeta#readme)
...
The agent supports three mutually-exclusive memory backends, selected via the `memory.backend` setting (Settings → Memory tab, or `~/.zeta/config.yml`):
