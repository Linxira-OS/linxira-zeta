 ...
 * - ~/.zeta/agent/extensions/ (legacy: ~/.pi/agent/extensions/)
 * - <cwd>/.zeta/extensions/ (legacy: <cwd>/.pi/extensions/)
...
//   1. Place extension files in ~/.zeta/agent/extensions/ or .zeta/extensions/
