...
import { toFirepassWireModelId, toFireworksWireModelId } from "@zeta/pi-catalog/fireworks-model-id";
import { isGlm52ReasoningEffortModelId, isKimiK3ModelId } from "@zeta/pi-catalog/identity";
...
} from "@zeta/pi-catalog/wire/coreweave";
