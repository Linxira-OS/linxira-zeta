...
import { authProviders } from "@linxiraos/pi-catalog/compat/auth";
import type { AuthProviderId, LoginProviderId } from "@linxiraos/pi-catalog/compat/auth-ids";
 ...
 * (`@linxiraos/pi-catalog` `rules/auth/*.kdl`) in `/login` display order.
