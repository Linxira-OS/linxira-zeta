...
import type { AssistantMessage, Message, Model, UserMessage } from "@linxiraos/pi-ai/types";
 ...
 *
 * Reproduces the shape captured in `~/.zeta/logs/http-400-requests/*.json` after Claude
