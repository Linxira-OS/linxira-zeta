...
```bash
npm install @zeta/pi-ai
```

## Quick Start

```typescript
import { getModel, stream, complete, Context, Tool, type } from "@zeta/pi-ai";
...
```typescript
import { type Tool, type } from "@zeta/pi-ai";
...
```typescript
import { stream, validateToolCall, Tool } from "@zeta/pi-ai";
...
```typescript
import * as fs from "node:fs";
import { getModel, complete } from "@zeta/pi-ai";
...
```typescript
import { getModel, streamSimple, completeSimple } from "@zeta/pi-ai";
...
```typescript
import { getModel, stream } from "@zeta/pi-ai";
...
```typescript
import { getProviders, getModels, getModel } from "@zeta/pi-ai";
...
```typescript
import { Model, stream } from "@zeta/pi-ai";
...
```typescript
import { getModel, complete, Context } from "@zeta/pi-ai";
...
```typescript
import { Context, getModel, complete } from "@zeta/pi-ai";
...
```typescript
import { getEnvApiKey } from "@zeta/pi-ai";
...
```typescript
import { loginGitHubCopilot } from "@zeta/pi-ai";
import * as fs from "node:fs";
...
```typescript
import { getModel, complete, getOAuthApiKey } from "@zeta/pi-ai";
import * as fs from "node:fs";
