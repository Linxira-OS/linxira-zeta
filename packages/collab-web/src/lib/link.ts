 ...
 * link/envelope half of `@linxiraos/zeta/src/collab/protocol.ts`;
...
import type { ParsedCollabLink } from "@linxiraos/pi-wire";
import {
	DEFAULT_RELAY_URL,
...
export { COLLAB_PROTO } from "@linxiraos/pi-wire";
