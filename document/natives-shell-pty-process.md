...
This document covers execution/process/terminal primitives in `@linxiraos/pi-natives`: `shell`, `pty`, `ps`, and `keys`, using the architecture terms from `document/natives-architecture.md`.
