...
}:
{
  ...
  "@huggingface/tasks@0.21.40" = fetchurl {
    url = "https://registry.npmjs.org/@huggingface/tasks/-/tasks-0.21.40.tgz";
    hash = "sha512-AaCt/0vjNZ+6WIsiLBzcCEHBQtYcz3lKn7+EFSu6Yw5xPBABYtky/iTsgEZrR41QYJqJLT54V2Q7YL1+pGb8Jw==";
  };
  ...
  "@linxiraos/hashline" = copyPathToStore ../packages/hashline;
  "@linxiraos/omp-stats" = copyPathToStore ../packages/stats;
  "@linxiraos/omptype" = copyPathToStore ../packages/omptype;
  ...
  "@linxiraos/pi-coding-agent" = copyPathToStore ../packages/coding-agent;
  ...
  "@linxiraos/snapcompact" = copyPathToStore ../packages/snapcompact;
