...
```ts
import { createAgentSession, discoverAuthStorage, ModelRegistry, SessionManager } from "@linxiraos/zeta";
...
```ts
import { createAgentSession, discoverAuthStorage, ModelRegistry, SessionManager, Settings } from "@linxiraos/zeta";
