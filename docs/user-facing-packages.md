...
- Package: `@zeta/swarm-extension`; bin: `omp-swarm`.
...
- Package: private `@zeta/terminal-bench`; bin: `tb2`.
...
- Package: `@zeta/omp-stats`; bin: `omp-stats`; main user path: `omp stats`.
...
- Package: private `@zeta/typescript-edit-benchmark`; bin: `typescript-edit-benchmark`.
