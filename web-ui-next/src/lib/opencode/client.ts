...
import { createZetaGatewayClient } from "@/lib/zeta/ZetaGatewayService";
...
// Exported singleton instance — routed through the zeta gateway bridge.
// Phase 1: intercepts boot-critical reads with empty data and delegates the
// rest to the original OpencodeService. Phase 2 implements real mappings.
export const opencodeClient = createZetaGatewayClient(
  new OpencodeService(),
