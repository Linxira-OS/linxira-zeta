...
export const dict = {
  ...
  'sessions.sidebar.project.actions.hideProject': 'Hide project',
  'sessions.sidebar.project.actions.showHiddenProjects': 'Show hidden projects ({count})',
  'sessions.sidebar.project.actions.sweepTempWorkspaces': 'Sweep temp workspaces',
  'sessions.sidebar.project.actions.sweepTempWorkspacesConfirm': 'Delete all sessions in the system temp directory? This removes temporary workspaces and cannot be undone.',
  'sessions.sidebar.project.actions.sweepTempWorkspacesDone': 'Deleted {count} temp workspace session(s)',
  'sessions.sidebar.project.actions.sweepTempWorkspacesError': 'Failed to sweep temp workspaces',
