...
export default defineConfig({
	...
	integrations: [
		starlight({
			...
			description:
				"TTT Editor — a terminal text editor. A real alternative to VS Code, Zed, and Sublime that runs in your terminal. Single Go binary, zero config.",
			social: [{ icon: "github", label: "GitHub", href: "https://github.com/eugenioenko/ttt" }],
			sidebar: [
				{
