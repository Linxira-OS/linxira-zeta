...
| Escape   | _(built-in)_      | Dismiss overlay / collapse cursors / focus the editor |
...
| Alt+Click | _(mouse)_                | Add cursor at click position                            |
| Escape    | _(built-in)_             | Collapse to single cursor (when multiple cursors exist) |
