...
<CardGrid stagger>
	<Card title="GUI in Your Terminal" icon="laptop">
		Menus, dialogs, mouse support, right-click context menus, and a file explorer. TTT is designed to feel like a
		desktop app, not a terminal one.
	</Card>
	...
	<Card title="Git Built In" icon="github">
		Stage, commit, push, inline diff view (partial and full-file), blame, and review GitHub PRs directly from the
		terminal.
	</Card>
